...
class _FreezerItemScreenState extends State<FreezerItemScreen> {
          ...
          child: Column(
            children: [
              ...
              DropdownButtonFormField<int>(
                ...
                value: _freezerItem.freezerId ?? _defaultFreezer(context),
              ...
              // FIXME: location - with suggestions from shelves
              DateTimeField(
  ...
  int? _defaultFreezer(final BuildContext context){
    return context.read<Freezers>().freezers[0].id;
  }

  List<DropdownMenuItem<int>> _availableFreezers(final BuildContext context) {
    return context.read<Freezers>().freezers
